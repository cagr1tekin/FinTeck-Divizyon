...
public class DetayModel : PageModel
{
    ...
    public DetayModel(ILogger<DetayModel> logger)
    {
        _logger = logger;
    }
    ...
    public IActionResult OnGet(string slug)
    {
        ...
        // Mock blog yazıları
        var allPosts = GetMockBlogPosts();
        Post = allPosts.FirstOrDefault(p => p.Slug == slug);
    ...
    private List<BlogPost> GetMockBlogPosts()
    {
        return new List<BlogPost>
        {
            new BlogPost
            {
                ...
                Excerpt = "Yılbaşı yaklaşırken kredi ihtiyacınız için en uygun zamanı belirlemek önemlidir.",
            ...
            new BlogPost
            {
                ...
                Excerpt = "Kredi kapatma sürecinde merak ettiğiniz tüm soruların cevaplarını bu kapsamlı rehberde bulabilirsiniz.",
            ...
            new BlogPost
            {
                ...
                Excerpt = "Ticari krediler hakkında bilmeniz gereken her şey. İşletmeniz için en uygun kredi türünü seçerken dikkat etmeniz gereken kriterler.",
